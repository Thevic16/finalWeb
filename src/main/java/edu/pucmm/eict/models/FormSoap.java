...
public class FormSoap {
  ...
  public FormSoap(String name, String lastName, String area, String schoolLevel, String latitude, String longitude, String user, String photoBase64) {
    this.name = name;
  ...
  @Override
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, formSoap.name) && Objects.equals(lastName, formSoap.lastName) && Objects.equals(area, formSoap.area) && Objects.equals(schoolLevel, formSoap.schoolLevel) && Objects.equals(latitude, formSoap.latitude) && Objects.equals(longitude, formSoap.longitude) && Objects.equals(user, formSoap.user) && Objects.equals(photoBase64, formSoap.photoBase64);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, lastName, area, schoolLevel, latitude, longitude, user, photoBase64);
  }
